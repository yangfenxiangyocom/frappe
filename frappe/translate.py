...
def get_dict(fortype, name=None):
	...
	if not asset_key in translation_assets:
		if fortype=="doctype":
			...
			messages += ['User List','POS Invoice','Deductions','Earnings','FIFO','Notes','Messages','Installer','Activity','Replied','Payment Pending','Paid','Cost Centers','Chargeable','Tax','Income Account','Expense Account','Fixed Asset','Cost of Goods Sold','Equity','Payable','Receivable','Warehouse','Cash','Bank','Group','Ledger','Overdue:','Default','Active','Desktop','Low','Medium','High','Standard','Overdue','Pending','Session Expired. Logging you out','Stock Item','Sales Item','Purchase Item','Manufactured Item','Shown in Website'];
